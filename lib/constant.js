const { getEnvConfig } = require("./env/utils/index");
const { envKeys, envValues } = require("./env");

/**
 * @typedef {Record<"MongoUri" | "Port" | "JwtSecret" | "JwtExpiry" | "JwtPassWordResetExpiry" | "ClientUrl" | "ClientUrlPic", string>} EnvMapper
 */
/**
 * @type {EnvMapper}
